...
export const translations: Translation = {
  ...
  aboutSiteContent: `Årets Framsteg är ett enkelt, elegant visualiseringsverktyg som visar hur mycket av det nuvarande året som har gått. Vårt mål är att hjälpa människor att få perspektiv på tidens gång och få mest möjligt ut av varje dag.
